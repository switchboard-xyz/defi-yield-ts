...
export interface LpInfo{
    ...
    lpApr:BigNumber;
    lpFeesApr:number;
    lpRewardAprA:BigNumber;
    lpRewardAprB:BigNumber;
...
export interface ReserveConfig {
    ...
    borrowYearCompoundedInterestRate:BigNumber,
    supplyYearCompoundedInterestRate:BigNumber,
...
export const ReserveParser = (pubkey: PublicKey, info: AccountInfo<Buffer>|null):Detail<Reserve> => {
    if (info==null){
