...
export const MiningIndexLayout: typeof BufferLayout.Structure =
  BufferLayout.struct([
...
export const MiningParser = (
  ...
  const miningIndices = BufferLayout.seq(MiningIndexLayout, reservesLen).decode(
    miningIndicesBuffer
  );
