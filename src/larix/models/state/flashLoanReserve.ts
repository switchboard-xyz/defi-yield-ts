...
export const FlashLoanReserveLayout: typeof BufferLayout.Structure =
  BufferLayout.struct([
...
export const isFlashLoanReserve = (info: AccountInfo<Buffer>) =>
  info.data.length === FlashLoanReserveLayout.span;

export const FlashLoanReserveParser = (
  pubkey: PublicKey,
